...
//                break
    ...
    public func sendEvent (buttonFlags: Int, x: Int, y: Int, pixelX: Int, pixelY: Int)
    {
        ...
        case .sgr:
            // Motion events (bit 32) always use the 'M' terminator: "no button"
            // motion encodes as 35, and misreading it as a release ('m' with the
            // button bits stripped) turns every pointer hover into a phantom
            // left-button release for SGR-aware TUIs.
